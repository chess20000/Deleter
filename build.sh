#!/bin/bash
# Build script for Deleter — produces a standalone .app bundle using swiftc.
...
SRC="$ROOT/Deleter"
BUILD="$ROOT/Build"
APP="$BUILD/Deleter.app"
BIN="$APP/Contents/MacOS/Deleter"
...
echo "==> Copying Assets…"
cp -R "$SRC/Assets.xcassets" "$APP/Contents/Resources/" 2>/dev/null || true
