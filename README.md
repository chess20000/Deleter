...
从 [Releases](https://github.com/chess20000/Deleter/releases) 下载 `Deleter.dmg`，将 Deleter.app 拖入 `/Applications`。由于未做开发者签名，首次打开会被拦截，在终端执行下面这行移除隔离属性即可：

```bash
xattr -dr com.apple.quarantine /Applications/Deleter.app
```
